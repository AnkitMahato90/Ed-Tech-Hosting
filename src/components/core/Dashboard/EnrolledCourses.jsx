  ...
  return (
    <>
      ...
      {!enrolledCourses ? (
        ...
        <p className="grid h-[10vh] w-full place-content-center text-richblack-500">
        ...
        <div className="my-8 text-richblack-700">
          ...
          <div className="flex rounded-t-lg bg-richblack-800 ">
            ...
            <p className="w-1/4 px-2 py-3 text-white">Duration</p>
            <p className="flex-1 px-2 py-3 text-white">Progress</p>
          </div>
          {/* Course Names */}
          {enrolledCourses.map((course, i, arr) => (
            <div
              className={`flex items-center border border-richblack-800 ${
            ...
            >
              ...
              >
                ...
                <div className="flex max-w-xs flex-col gap-2">
                  <p className="font-semibold text-richblack-900">{course.courseName}</p>
